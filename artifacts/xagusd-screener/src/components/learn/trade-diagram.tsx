    ...
    <div className="font-mono space-y-3">
      ...
      <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-3">
        <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`} style={{ width: "100%", height: "auto" }}>
          ...
          <rect x={padL} y={toY(entry)} width={chartW} height={toY(sl) - toY(entry)} fill="#ef5350" fillOpacity="0.06"/>
          <rect x={padL} y={toY(tp2)} width={chartW} height={toY(entry) - toY(tp2)} fill="#26a69a" fillOpacity="0.06"/>
          ...
          <path d={pathD} fill="none" stroke="#ffd54f" strokeWidth="1.5" clipPath="url(#learn-chart-clip)"/>
          ...
          <line x1={padL + chartW - 20} y1={toY(entry)} x2={padL + chartW - 20} y2={toY(sl)} stroke="#ef5350" strokeWidth="1.5" strokeOpacity="0.6"/>
          ...
          <line x1={padL + chartW - 20} y1={toY(entry)} x2={padL + chartW - 20} y2={toY(tp2)} stroke="#4caf50" strokeWidth="1.5" strokeOpacity="0.6"/>
